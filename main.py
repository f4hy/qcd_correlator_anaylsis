...
data_folder = "/home/bfahy/r3/results/michael12beta5.9/data/"

out_folder ="/home/bfahy/plots/testing/"
...
def compute_and_plot(srcop,snkop,data_folder,out_folder,name):
    ...
    corr = correlator.Correlator.fromOpvalCTO(srcdata,snkdata)
...
compute_and_plot(srcop,snkop,data_folder,out_folder,name)
